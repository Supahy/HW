...
@Override
    ...
    Processor clonedProc = (Processor) super.clone();
        HardDrive clonedHardDrive = (HardDrive) super.clone();
        cloned.setHardDrive(clonedHardDrive);
        cloned.setProcessor(clonedProc);
        return cloned;
